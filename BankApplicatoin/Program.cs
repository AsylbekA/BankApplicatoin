...
namespace BankApplicatoin
{
    class Program
    {
        static void Main(string[] args)
        {
            Bank<Account> bank = new Bank<Account>("Жилстройсбербанк");
            bool alive = true;
            while (alive)
            {
                ...
                {
                    // вывод сообщение об ошибке красным цветом
        ...
        private static void OpenAccount(Bank<Account> bank)
        {
            ...
            bank.Open(accountType,
                ...
                WithrawSumHandler, // обработчик вывода средств
        ...
        {
            Console.WriteLine("Укажте сумму для вывода са счета:");
        ...
        private static void AddSumHandler(object serder,AccountEventArgs e)
        {
            Console.WriteLine(e.Message);
        }
        // обработчик вывода средств
        private static void WithrawSumHandler(object sender, AccountEventArgs e)
        {
            Console.WriteLine(e.Message);
            if (e.Sum > 0)

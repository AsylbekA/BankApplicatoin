...
namespace BankLibrary.Model
{
    ...
    class Bank<T> where T:Account
    {
        ...
        // метод содания счета
        public void Open(AccountType accountType,decimal sum,AccountStateHandler addSumhandler,AccountStateHandler withrawSumHandler,
            ...
            AccountStateHandler openAccountHandler)
        {
            ...
            if (newAccount == null)
                throw new Exception("Ошибка создана счета");
            ...
            newAccount.Withreved += withrawSumHandler;
        ...
        public void Close(int id)
        {
            ...
            {
                //уменшаем массив счетов, удаляя из него закрытый счет
                T[] tempAccounts = new T[accounts.Length-1];
